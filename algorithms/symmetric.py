...
def show_symmetric_interface(root, algorithm, back_command, home_command, bg_color, button_color, text_color,
                             accent_color):
    ...
    iv_entry_label.grid(row=1, column=0, padx=(0, 10), pady=(8, 0), sticky="w")
    ...
    iv_entry.grid(row=1, column=1, sticky="ew", padx=(0, 10), pady=(8, 0))
    ...
    gen_iv_btn.grid(row=1, column=2, pady=(8, 0))
