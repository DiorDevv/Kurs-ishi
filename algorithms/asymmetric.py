...
def show_asymmetric_interface(root, algorithm, back_command, bg_color, button_color, text_color, accent_color):
    ...
    keys_display.pack(fill="x", padx=10, pady=(5, 5))
    ...
    output_text.pack(fill="both", expand=True, padx=10, pady=(5, 10))
    ...
    def decrypt():
        try:
            ...
            if algorithm == "rsa":
                ...
                messagebox.showinfo("Ma'lumot", "El-Gamal deshifrlash uchun ciphertext juftliklarini kiritish kerak.\nMasalan: [(5, 10), (7, 15)]")
